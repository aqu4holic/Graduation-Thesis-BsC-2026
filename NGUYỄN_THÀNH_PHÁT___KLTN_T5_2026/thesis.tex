...
\usepackage{url}
\urlstyle{same}
\def\UrlBreaks{\do\.\do\@\do\\\do\/\do\!\do\_\do\#\do\-\do\:\do\~\do\%\do\(\do\)}
...
%
\title{Causal Inference on Time Series Data}	%% title
\author{Nguyen Thanh Phat}			%% author's name
...
\definecolor{codeyellow}{rgb}{1.0, 0.9, 0.0}
